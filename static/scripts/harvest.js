...
(function() {
  var ERROR_THRESHOLD, MAX_DISTANCE, canvas, ctx, onError, onPredictClose, onSuccess, onTrainClose, predict, setBarWidth, setupWS, showFace, train, update, video,
    _this = this;
  ...
  train = function() {
    ...
    startHarvest = function() {
      ...
      return window.ws.onmessage = function(e) {
        ...
        window.ws.close();
        return setBarWidth(70, 'Training model');
      };
    };
