...
(function() {
  var ERROR_THRESHOLD, MAX_DISTANCE, canvas, ctx, onError, onPredictClose, onSuccess, onTrainClose, predict, setupWS, showFace, train, update, updateProgressBar, video,
    _this = this;
